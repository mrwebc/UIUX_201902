...
$(document).ready(function(){
   ...
   $("li:nth-child(3)").on("click",function(evt){
      ...
      $("li").removeAttr("class");
      $("li:nth-child(3)").attr("class","on");
   });

	//4번째 썸네일에 대한 클릭이벤트 구문
   $("li:nth-child(4)").on("click",function(evt){
      ...
      $("li").removeAttr("class");
      $("li:nth-child(4)").attr("class","on");
   });

	//5번째 썸네일에 대한 클릭이벤트 구문
